...
bool check_ktabletconfig_xsetwacom() {
    ...
    fp = popen("exec ktabletconfig --binding --stylus \"Wacom Intuos BT S Pen\" \"--button\" 3", "r");
    if (fp != NULL) {
    ...
    if (!result) {
        fp2 = popen("exec xsetwacom --get \"Wacom Intuos BT S Pen stylus\" \"button 2\"", "r");
        if (fp2 != NULL) {
...
void* delayed_release_function(void* arg) {
    ...
    if (delayed_release_active) {
        ...
        execute_command("exec xdotool keyup Control_R");
                ...
                *ctrl_pressed = keyboard_ctrl_active;
                ...
                if (ev->value == 0) {
                    ...
                    if (tablet_ctrl_active) {
                        ...
                        execute_command("exec xdotool keydown Control_R");
                    } else {
