//22. The major change here is changing ydotool to Xdotool, also I ***think*** moving most of those commands to control R not L.
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
                ...
                *ctrl_pressed = keyboard_ctrl_active;
                ...
                if (ev->value == 0) {
                    ...
                    if (tablet_ctrl_active) {
                        ...
                        printf("Keyboard CTRL released with no tablet CTRL - sending CTRL release via xdotool + kB\n");
                        // execute_command("ydotool key 97:0");
                        // execute_command("ydotool key 97:0");
                        execute_command("xdotool keyup Control_R");
                        execute_command("xdotool keyup Control_R");
